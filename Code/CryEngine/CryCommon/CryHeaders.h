...
enum ECgfStreamType
{
	...
	CGF_STREAM_INDICES,
	CGF_STREAM_TANGENTS,
	CGF_STREAM__DUMMY0,  // used to be CGF_STREAM_SHCOEFFS, dummy is needed to keep existing assets loadable
	CGF_STREAM__DUMMY1,  // used to be CGF_STREAM_SHAPEDEFORMATION, dummy is needed to keep existing assets loadable
