...
ActorShared =
{
	...
	-- Flo/Tomas comment out the pain and death entries to prevent playback
	-- If pain and death are re-enabled they should not be hardcoded in a lua file
	player =
	{
		pain =
		{
		...
		pain_mp =
		{
			{"languages/dialog/ai_marine/pain_01.wav"},
			{"languages/dialog/ai_marine/pain_02.wav"},
			{"languages/dialog/ai_marine/pain_03.wav"},
			{"languages/dialog/ai_marine/pain_04.wav"},
			{"languages/dialog/ai_marine/pain_05.wav"},
			{"languages/dialog/ai_marine/pain_06.wav"},
			{"languages/dialog/ai_marine/pain_07.wav"},
			{"languages/dialog/ai_marine/pain_08.wav"},
			{"languages/dialog/ai_marine/pain_09.wav"},
			{"languages/dialog/ai_marine/pain_10.wav"},
		},
		...
		death_mp =
		{
			{"languages/dialog/ai_marine/death_00.wav"},
			{"languages/dialog/ai_marine/death_01.wav"},
			{"languages/dialog/ai_marine/death_02.wav"},
			{"languages/dialog/ai_marine/death_03.wav"},
			{"languages/dialog/ai_marine/death_04.wav"},
			{"languages/dialog/ai_marine/death_05.wav"},
			{"languages/dialog/ai_marine/death_06.wav"},
			{"languages/dialog/ai_marine/death_07.wav"},
			{"languages/dialog/ai_marine/death_08.wav"},
			{"languages/dialog/ai_marine/death_09.wav"},
		},
	},

	splash_sounds =
	{
		{"sounds/physics:foleys/npc:bodyfall_water_deep", SOUND_DEFAULT_3D, 200, 5, 60},
	},
}
...
function BasicActor:DoPainSounds(dead)
	...
	if (self.actor:IsPlayer()) then
		...
		if (sound) then
			...
			self.lastPainSound = self:PlaySoundEventEx(sound[1], sndFlags, 0, volume, g_Vectors.v000, -1, -1, SOUND_SEMANTIC_PLAYER_FOLEY);
		...
		if (dead) then
			AI.PlayCommunication(self.id, "death", "Injury", 0.5);
		else
			self.lastPainSound = AI.PlayCommunication(self.id, "pain", "InjuryPain", 0.5);
		end
