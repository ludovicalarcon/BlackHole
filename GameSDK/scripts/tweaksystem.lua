...
if (not Tweaks.Scratchpad) then
	Tweaks.Scratchpad = 
	{
		...
		REPEATRATE = 0.2,				-- Period of input repeat rate
		REPEATDELAY = 0.4,			-- Delay before first input repeat
		FONTSIZE = 1.5,
		VERTSPACE = 24,
		MOTD = false,
		SHOWHIDDEN = false,
...
--Tweaks.ReloadStructure();		-- Causes recursive loading (A loads B which loads A etc)
