...
--	},
	...
	signalAdvanceleft  = {
			{
				PROBABILITY = 1000,
				animationName = "signalAdvanceleft",
				duration = 3,
			},
	},
	...
	signalAdvanceright  = {
			{
				PROBABILITY = 1000,
				animationName = "signalAdvanceright",
				duration = 3,
			},
	},
	
	signalAdvanceforward  = {
			{
				PROBABILITY = 1000,
				animationName = "signalAdvanceforward",
				duration = 3,
			},
	},	
