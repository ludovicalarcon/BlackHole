...
Elevator =
{
	...
	Properties =
	{
		...
		Sounds =
		{
			soundSoundOnStart = "Sounds/environment:city:atrium_elevator_start",
			soundSoundOnMove = "Sounds/physics:objects/fridge:run_loop",
			soundSoundOnStop = "Sounds/environment:city:atrium_elevator_stop",
		},
