...
Human_x =
{
	...
	Properties =
	{
		...
		esModularBehaviorTree = "SDK_Grunt_04",
		...
		equip_EquipmentPack = "Player_Default",
...
function Human_x:CheckMountedWeaponTarget()
	...
	-- Marcio: don't perform these checks for vehicles
	-- designers will send the leave command in this case
